...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let sumResult = sum(a, b)[0];
  sumResult = sum(sumResult, c)[0];
  let productResult = multiply(a, b)[0];
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  return [productResult, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${productResult}.`];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (let i = 0; i < dynamicArray.length; i++) {
    productResult = multiply(productResult, dynamicArray[i])[0];
  ...
  return [productResult, `The numbers ${resultString} have a product of ${productResult}.`];
}
